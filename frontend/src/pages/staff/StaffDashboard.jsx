...
export default function StaffDashboard() {
  ...
  const topCaseItem =
    [...systemSummaryChartData].sort((a, b) => b.value - a.value)[0] || {
      name: "No Data",
      value: 0,
    };
  ...
  const offenseChartData = Array.isArray(summary?.offenses)
    ? summary.offenses.slice(0, 5).map((item) => ({
                ...
                <div className="chart-card-header">
                  <div>
                    ...
                    <p className="panel-subtitle">
                      Most recorded offenses overview
                    </p>
                  </div>
                </div>

                <div className="offenses-chart-wrap">
                  {offenseChartData.length > 0 ? (
                    ...
                    <div className="empty">
                      No offense/violation data available.
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="budget-style-layout">
                  <div className="budget-style-legend">
                    {systemSummaryChartData.map((item, index) => (
                      <div key={item.name} className="budget-style-legend-item">
                        ...
                        <span className="budget-style-legend-value">
                          {item.value}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="budget-style-chart-side">
                    <div className="budget-style-floating-chip">
                      <span className="budget-style-chip-percent">
                        {topCasePercent}%
                      </span>
                    ...
                    <div className="budget-style-chart-wrap">
                      ...
                      <div className="budget-style-center-label">
                        <div className="budget-style-center-subtitle">
                          Total cases
                        </div>
                        <div className="budget-style-center-value">
                          {totalSystemCases}
                        </div>
                      </div>
                    </div>
